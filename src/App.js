...
import LoginFrom './components/LoginForm'
...
class App extends Component{
  ...
  render(){
      ...
      return(
        <ThemeAbdVideoContext.Provider value={{
            savedVideos , isDarkTheme , activeTab , toggleTheme:this.toggleTheme , addVideo:this.addVideo , changeTab:this.changeTab
        }}>
            <Switch>
